...
import GoverPhoto from '../assets/Amboseli Gover Photo.jpg'; 
...
const Amboseli = () => {
  return (
    <div className="amboseli">
      <img src={GoverPhoto} alt="Amboseli National Park" className="cover-image" /> 
      ...
      <div className="image-gallery">
        ...
        <img src={AmboseliGalary1} alt="Amboseli Galaryy 1" />
