    ...
    <div className="make-a-difference">
      ...
      <div className="travel-green-section">
        <div className="text-content">
          ...
          <p>
            At Nalazuri Travels, we believe that traveling should not only be an
        ...
        <div className="make-difference-project">
          ...
          <div className="make-difference-columns">
            <div>
              <p className="make-difference-paragraph">
                ...
                at <strong>Mukuru Primary and Junior High School</strong>, in
                partnership with{" "}
                <a
              ...
              <p className="make-difference-paragraph">
                ...
                <strong>100 students</strong> through{" "}
                <strong>Education for Sustainable Development</strong>, by{" "}
          ...
          <div className="make-difference-highlight">
            ...
            <p className="make-difference-paragraph">
              ...
              largest informal settlements, the school remains a vital access
              point for education in an area facing{" "}
      ...
      <section className="donation-section">
        ...
        <div className="donation-description">
          <p>
            Our goal is to contribute at least $10,000 over five years to
            provide students with the resources and education they need.
          </p>
        </div>
        <div className="donation-grid">
          <div className="donation-card">
            ...
            <p>
              ...
              computers, mobile phones, cameras, and GIS applications.
            </p>
          </div>
          <div className="donation-card">
            ...
            <p>
              Expand our reach by funding student participation and
      ...
      <div className="goal-commitment-section">
        <div className="goal-card">
          ...
          <p>
            Trees planted towards our annual goal of {totalGoal.toLocaleString()}
          </p>
        </div>
        ...
        <div className="commitment-card">
          ...
          <p>
            Nalazuri Travels commits <strong>5% of profits</strong> to this
            mission. Every trip you book helps fund:
          </p>
      ...
      <div className="donation-section">
        ...
        <div className="donation-card">
          ...
          <p className="donation-amount">
            ${donationAmount.toLocaleString()} of ${totalGoal.toLocaleString()} Goal
          </p>
